...
<f:form method="post" action="${contextPath}/admin/saveProduct" modelAttribute="product"
				...
				<div class="card card-primary">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<f:input id="inputName" path="proId" class="form-control" />
							<f:errors  class="text-danger" path="proId"></f:errors>
						</div>
						<div class="form-group">
							<label for="inputName">Product Name</label>
							<f:input id="title" path="proName" class="form-control" onkeyup="ChangeToSlug()" />
						...
						<div class="form-group">
							<label for="inputName"> Image</label> <input id="inputName"
								...
								<img alt="" width="300px" id="preview" src="">
								<p class="text-danger">${fileError }</p>
						</div>
						<div class="form-group">
							<label for="inputName"> Images</label> <input id="inputName"
								name="files" type="file" multiple="multiple" class="form-control" />
						</div>
						<div class="col-md-10 m-auto p-3">
							<a href="${contextPath}/admin/product" class="btn btn-secondary">Cancel</a> <input
								type="submit" value="Create new Product"
